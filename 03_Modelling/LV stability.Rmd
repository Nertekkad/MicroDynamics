...
Let's consider an hipothetical population that grows at an \$ r \$ rate: \$ \dot{x} = rx \$. If \$ r\>0 \$, the population will increase exponentially \$ x(t) = x\_{0}e\^{rt} \$, a model that doens't make any biological sense.
